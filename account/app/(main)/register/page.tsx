      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-xl">
          ...
          <p className="text-gray-500 text-center mb-8">
            Get started with Lead Agents Studio
          </p>

          {/* Google Sign Up */}
          <button
            onClick={handleGoogleLogin}
            className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 rounded-xl px-4 py-3 font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-400 transition-all mb-6"
          >
          ...
          <form onSubmit={handleRegister}>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="btn-primary btn-gradient w-full disabled:opacity-50 disabled:cursor-not-allowed"
            >
